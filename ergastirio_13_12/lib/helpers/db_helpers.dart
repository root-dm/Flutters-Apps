...
class DBHelper{
   //function to insert to database
    ...
    static Future<sql.Database> database() async{
     ...
     final dbPath = await sql.getDatabasesPath(); //to path αναλογα android/iOS επιστρεφει ενα future γιαυτο εχουμε βαλει το await.
   ...
   static Future _createDB(db,version){
        ...
        CREATE TABLE notes(
          ...
          title TEXT NOT NULL, 
          text TEXT NOT NULL, 
          extra TEXT)'''); //επιστρεφει ενα future και με το return ενημερωνει ποτε επιστρεφεται το future
     }
