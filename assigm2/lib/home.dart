...
class _HomePageState extends State<HomePage> {
              ...
              children: [
                Padding(
                  padding: EdgeInsets.symmetric(
                      vertical: 20.0), //συμμετρικη αποσταση στον καθετο αξονα
                  child: Material(
                    ...
                    child: Container(
                      height:
                          150, //χρειαζονται για να φανει η στρογγυλοποιηση του Material αλλιως η εικονα ειναι μεγαλυτερη και δεν φαινεται (στο συγκεκριμενο παραδειγμα)
                      width: 150,
                      child: ClipOval(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: [
          customcard("Suggestions", 'assets/images/suggestion.png',
              '/cardpagesuggestions'),
          customcard("Questionnaire", 'assets/images/que.png',
              '/cardpagequestionnaire'),
        ],
      ),
    );
  }
