...
class UserData extends StatefulWidget {
  final List user;
  const UserData(this.user); // edw pairnei to user apo to homescreen
...
class _UserDataState extends State<UserData> {
  updater(
    ...
    // Me auton ton tropo kanei redirect sto login gia na kanei update ta userdata
  }
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      Center(
                          child:
                              //ta widget.user einai data pou erxontai mesa apo to redirect twn pages
                      ...
                      TextFormField(
                        decoration: InputDecoration(
                          hintText: widget.user[0]['surname'],
                          border: OutlineInputBorder(),
                        ),
